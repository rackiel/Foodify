...
try {
    ...
    // Get admin actions/logs (placeholder for future implementation)
    $admin_actions = [
        'users_approved' => 0,
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-md-6">
                                ...
                                <p class="text-muted mb-2">
                                    <i class="bi bi-person-badge"></i> <?= ucfirst($user_data['role'] ?? 'Administrator') ?>
                                </p>
                                <p class="mb-2">
                            ...
                            <div class="col-md-3">
                                <div class="text-center">
                                    <span class="badge bg-danger badge-lg mb-2">
                    ...
                    <div class="card-body">
                        <div class="tab-content">
                            ...
                            <div class="tab-pane fade show active" id="announcements">
                                <h5 class="mb-3">My Recent Announcements</h5>
                                <?php if (!empty($recent_announcements)): ?>
                                    <div class="list-group">
                                        <?php foreach ($recent_announcements as $announcement): ?>
                                            <a href="../teamofficer/announcements.php" class="list-group-item list-group-item-action">
                                    ...
                                    <div class="text-center mt-3">
                                        <a href="../teamofficer/announcements.php" class="btn btn-outline-primary">
                                ...
                                <?php else: ?>
                                    <div class="text-center py-5">
                                        ...
                                        <a href="../teamofficer/announcements.php" class="btn btn-primary">
                                    ...
                                    <div class="list-group">
                                        <?php foreach ($recent_comments as $comment): ?>
                                            <div class="list-group-item">
                                                <div class="d-flex w-100 justify-content-between">
                                                    <small class="text-muted">On: <?= htmlspecialchars($comment['announcement_title'] ?? 'Post') ?></small>
